...
public class AddPanel extends JPanel implements ActionListener {
	...
	private void addLabeledField(JPanel fieldPanel2, String labelText2, Object lastNameField) {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if ("ok".equalsIgnoreCase(e.getActionCommand())) {
			...
			try {
				user.setDateOfBithd(format.parse(getDateOfBirthField().getText()));
